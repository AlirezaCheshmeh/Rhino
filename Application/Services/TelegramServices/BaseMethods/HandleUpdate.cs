...
namespace Application.Services.TelegramServices.BaseMethods
{
    public class HandleUpdate : IHandleUpdates, IScopedDependency
    {
                ...
                if (update.CallbackQuery is not null)
                {
                    ...
                    //handle other states
                        ...
                        commandState = callBackData switch
                        {
                            ...
                            ConstCallBackData.Report.InboundToday => CommandState.InboundTodayReportsDynamicType,
                            ConstCallBackData.Report.InBoundTodayReport => CommandState.InboundTodayReport,
                            ConstCallBackData.Report.InboundYesterday => CommandState.InboundYesterdayReportsDynamicType,
                            ConstCallBackData.Report.InBoundYesterdayReport => CommandState.InboundYesterdayReport,
                            ConstCallBackData.Report.InboundLastWeek => CommandState.InboundLastWeekReportsDynamicType,
                            ConstCallBackData.Report.InBoundLastWeekReport => CommandState.InboundLastWeekReport,
                            ConstCallBackData.Report.InboundLastMonth => CommandState.InboundLastMonthReportsDynamicType,
                            ConstCallBackData.Report.InBoundLastMonthReport => CommandState.InboundLastMonthReport,
                            ConstCallBackData.Report.InBoundTodaySummaryReport => CommandState.InboundSummary,
                            ConstCallBackData.Report.InBoundYesterdaySummaryReport => CommandState.InboundYesterdaySummary,
                            ConstCallBackData.Report.InBoundLastWeekSummaryReport => CommandState.InboundLastWeekSummaryReport,
                            ConstCallBackData.Report.InBoundLastMonthSummaryReport => CommandState.InboundLastMonthSummaryReport,
                            ConstCallBackData.Report.OutBoundTodaySummaryReport => CommandState.OutboundSummary,
                            ConstCallBackData.Report.OutBoundLastMonthReport => CommandState.OutboundLastMonthReport,
                            ConstCallBackData.Report.OutBoundYesterdaySummaryReport => CommandState.OutboundYesterdaySummaryReport,
                            ConstCallBackData.Report.OutBoundLastWeekSummaryReport => CommandState.OutboundLastWeekSummaryReport,
                            ConstCallBackData.Report.OutBoundLastMonthSummaryReport => CommandState.OutboundLastMonthSummaryReport,
                            ConstCallBackData.Report.OutBound => CommandState.OutboundReport,
                            ConstCallBackData.Report.OutboundToday => CommandState.OutboundTodayReportsDynamicType,
                            ConstCallBackData.Report.OutBoundTodayReport => CommandState.OutboundTodayReport,
                            ConstCallBackData.Report.OutboundYesterday => CommandState.OutboundYesterdayReportsDynamicType,
                            ConstCallBackData.Report.OutBoundYesterdayReport => CommandState.OutboundYesterdayReport,
                            ConstCallBackData.Report.OutboundLastWeek => CommandState.OutboundLastWeekReportsDynamicType,
                            ConstCallBackData.Report.OutBoundLastWeekReport => CommandState.OutboundLastWeekReport,
                            ConstCallBackData.Report.OutboundLastMonth => CommandState.OutboundLastMonthReportsDynamicType,
                            //report end=================================================================
        ...
        public enum CommandState
        {
            ...
            InboundReport,
            InboundSummary,
            InboundYesterdaySummary,
            InboundTodayReport,
            InboundLastWeekReport,
            InboundLastMonthReport,
            InboundYesterdayReport,
            OutboundTodayReport,
            OutboundYesterdaySummaryReport,
            OutboundLastWeekReport,
            OutboundLastMonthReport,
            OutboundYesterdayReport,
            OutboundSummary,
            OutboundReport,
            InboundTodayReportsDynamicType,
            InboundYesterdayReportsDynamicType,
            InboundLastWeekReportsDynamicType,
            InboundLastMonthReportsDynamicType,
            OutboundTodayReportsDynamicType,
            OutboundYesterdayReportsDynamicType,
            OutboundLastWeekReportsDynamicType,
            OutboundLastMonthReportsDynamicType,
            InboundLastWeekSummaryReport,
            InboundLastMonthSummaryReport,
            OutboundLastWeekSummaryReport,
            OutboundLastMonthSummaryReport,
        }
